...
$dbpass = '';
$dbname = 'wilayah';
$dbconf = "mysql:dbname=$dbname;host=$dbhost";
try {
	$db = new PDO($dbconf, $dbuser, $dbpass);
...
if (isset($_GET['id']) && !empty($_GET['id'])) {
	...
	<body>
		<div class="card">
			<table class="table" padding="10px" cellspacing="0" cellpadding="0">
				<tr>
					<td>Provinsi</td>
					<td>
